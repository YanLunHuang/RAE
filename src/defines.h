...
typedef ap_fixed<18,8> active_bits_table_t;
typedef ap_fixed<32,16> input10_t;
typedef ap_fixed<32,16> layer11_t;
typedef ap_fixed<33,11> accum12_t;
...
typedef ap_ufixed<8,0,AP_RND_CONV,AP_SAT> recr_act12_t;
typedef ap_fixed<8,1,AP_RND_CONV,AP_SAT> state12_t;
typedef ap_ufixed<2,0> slope12_t;
typedef ap_ufixed<2,0> shift12_t;
typedef ap_fixed<17,2> layer12_t;
typedef ap_fixed<25,11> accum_dense12_t;
...
typedef ap_fixed<18,8> active_bits4_table_t;
*/
#endif
