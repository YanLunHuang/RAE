...
void dense_loop_d3(
    ...
    for(int count=0;count<3;count++){
        ...
        nnet::dense_resource_rf_leq_nin_d3<data_T, res_T, CONFIG_T>(count, data, res, weights_v1,weights_v2,weights_v3, biases);
    }
}

template <class data_T, class res_T, typename CONFIG_T>
void gru_static(bool reset_state, data_T data[CONFIG_T::n_in], res_T h_newstate[CONFIG_T::n_state],
                typename CONFIG_T::weight_t param_v1[CONFIG_T::n_state * 3 * CONFIG_T::n_in/3],
                typename CONFIG_T::weight_t param_v2[CONFIG_T::n_state * 3 * CONFIG_T::n_in/3],
                typename CONFIG_T::weight_t param_v3[CONFIG_T::n_state * 3 * CONFIG_T::n_in/3],
                typename CONFIG_T::weight_t param_zr_v1[CONFIG_T::n_state * 3 * CONFIG_T::n_state/3],
                typename CONFIG_T::weight_t param_zr_v2[CONFIG_T::n_state * 3 * CONFIG_T::n_state/3],
                typename CONFIG_T::weight_t param_zr_v3[CONFIG_T::n_state * 3 * CONFIG_T::n_state/3],
                typename CONFIG_T::bias_t param_b[CONFIG_T::n_state * 3],
                typename CONFIG_T::bias_t param_br[CONFIG_T::n_state * 3]) {
    // Initialize the state variable -- will maintain state between function calls
std::cout <<"gru_static"<<std::endl;
    static res_T h_state[CONFIG_T::n_state];
    ...
    #pragma HLS ARRAY_PARTITION variable=qh_state        complete
    //#pragma HLS ARRAY_PARTITION variable=h_state         complete
    //#pragma HLS ARRAY_PARTITION variable=h_newstate      complete
    //#pragma HLS ARRAY_PARTITION variable=tmpres          complete
    //#pragma HLS ARRAY_PARTITION variable=tmpres_state_zr complete
    ...
    nnet::dense_loop_d3<data_T, typename CONFIG_T::accum_dense_t, typename CONFIG_T::mult_config1>(data, tmpres, param_v1, param_v2, param_v3, param_b);
    nnet::dense_loop_d3<typename CONFIG_T::state_t, typename CONFIG_T::accum_dense_t, typename CONFIG_T::mult_config2>(qh_state, tmpres_state_zr, param_zr_v1,param_zr_v2,param_zr_v3,
                                                                                    param_br);
...
std::cout <<"gru_stack"<<std::endl;
    ...
    for (int iloop = 0; iloop < CONFIG_T::n_sequence; iloop++) {
        ...
        //if (CONFIG_T::use_static)
        nnet::gru_static<data_T, res_T, CONFIG_T>(reset_state, data_in, h_state, param_v1, param_v2, param_v3, param_zr_v1, param_zr_v2,param_zr_v3, param_b, param_br);
