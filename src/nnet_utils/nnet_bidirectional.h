...
template<class data_T, class res_T, typename CONFIG_T>
  void bidirectional_single(
      ...
      typename CONFIG_T::weight_t     bweight_v1     [CONFIG_T::n_state*3*CONFIG_T::n_in/2],
      typename CONFIG_T::weight_t     bweight_v2     [CONFIG_T::n_state*3*CONFIG_T::n_in/2],
      typename CONFIG_T::weight_t     brecweight_v1  [CONFIG_T::n_state*3*CONFIG_T::n_state/2],
      typename CONFIG_T::weight_t     brecweight_v2  [CONFIG_T::n_state*3*CONFIG_T::n_state/2],
      typename CONFIG_T::bias_t       bbais       [CONFIG_T::n_state*3],
      typename CONFIG_T::bias_t       bbias_r     [CONFIG_T::n_state*3],
      typename CONFIG_T::weight_t     fweight_v1     [CONFIG_T::n_state*3*CONFIG_T::n_in/2],
      typename CONFIG_T::weight_t     fweight_v2     [CONFIG_T::n_state*3*CONFIG_T::n_in/2],
      typename CONFIG_T::weight_t     frecweight_v1  [CONFIG_T::n_state*3*CONFIG_T::n_state/2],
      typename CONFIG_T::weight_t     frecweight_v2  [CONFIG_T::n_state*3*CONFIG_T::n_state/2],
    ...
    nnet::gru_stack<data_T, res_T, typename CONFIG_T::config_rnn_layer_f>(temp_normal, forwardgru_out, fweight_v1, fweight_v2, frecweight_v1, frecweight_v2, fbias, fbias_r);
    //nnet::gru_stack<data_T, res_T, typename CONFIG_T::config_rnn_layer_b>(temp_reverse, backwardgru_out, bweight, brecweight, bbais, bbias_r);
    nnet::gru_stack<data_T, res_T, typename CONFIG_T::config_rnn_layer_b>(temp_reverse, backwardgru_out, bweight_v1, bweight_v2, brecweight_v1, brecweight_v2, bbais, bbias_r);
